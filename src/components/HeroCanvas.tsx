...
export const HeroCanvas: React.FC = () => {
  ...
  useEffect(() => {
    ...
    // 1. Golden Stardust & Ember Particles (Super-optimized count for 60fps)
    ...
    for (let i = 0; i < particleCount; i++) {
      ...
      let c = goldColor;
      if (rand < 0.45) c = goldColor;
      else if (rand < 0.75) c = orangeColor;
      else if (rand < 0.9) c = redColor;
      else c = whiteColor;
    ...
    // Fast circular particle canvas texture
    ...
    if (ctx) {
      ...
      gradient.addColorStop(0.3, 'rgba(255, 215, 0, 0.85)');
      gradient.addColorStop(0.8, 'rgba(255, 140, 0, 0.2)');
    ...
    const pointLight = new THREE.PointLight(0xff8c00, 2.5, 40);
