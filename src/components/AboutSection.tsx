        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <BlurReveal delay={0.2}>
            <h2 className="font-display text-3xl sm:text-4xl md:text-5xl font-extrabold text-white tracking-tight mb-5">
              Devotion, Culture & <span className="gold-gradient-text">Eternal Heritage</span>
            </h2>
          </BlurReveal>

          <BlurReveal delay={0.3}>
            <p className="text-gray-400 text-base sm:text-lg leading-relaxed font-sans">
              Every year, the youth of Maraigudem come together with pure hearts to craft an extraordinary spiritual experience for thousands of visiting devotees from all neighboring districts.
            </p>
          </BlurReveal>
        </div>
          ...
          {cards.map((card, idx) => (
            ...
            >
              ...
              >
                ...
                {/* Footer Stat Row */}
                <div className="pt-4 border-t border-white/5 flex items-center justify-between text-xs text-[#FFD700] font-semibold font-sans">
                  <span>{card.stats}</span>
                  <span className="text-gray-400 group-hover:text-white transition-colors">Maraigudem Youth</span>
                </div>
              </TiltCard>
            </motion.div>
          ))}
